<div id="livewire-loading-spinner" class="fade position-fixed start-0 end-0 bottom-0 text-center mb-3 pe-none"
     style="z-index: 1090;" data-show-delay="{{ config('gesanda.livewire_loading_spinner.show_delay') }}">
...
<style>
    #livewire-loading-spinner svg {
        -webkit-animation: spin {{ config('gesanda.livewire_loading_spinner.animation_speed') }}ms linear infinite;
        -moz-animation: spin {{ config('gesanda.livewire_loading_spinner.animation_speed') }}ms linear infinite;
        animation: spin {{ config('gesanda.livewire_loading_spinner.animation_speed') }}ms linear infinite;
    }
    @-moz-keyframes spin {
        100% {
